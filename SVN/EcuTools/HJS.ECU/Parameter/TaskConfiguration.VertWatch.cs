/*
 * Object: HJS.ECU.Parameter.TaskConfiguration.VertWatch
 * Description: task configuration for VertWatch
 * 
 * $LastChangedDate: 2014-11-03 16:18:26 +0100 (Mo, 03 Nov 2014) $
 * $LastChangedRevision: 74 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/HJS.ECU/Parameter/TaskConfiguration.VertWatch.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
namespace HJS.ECU.Parameter
{
    ...
    {
        private UInt16 SizeVertWatch7() { return 8; }
        private bool ImportVertWatch7(UInt16 Offset, ref byte[] Data)
        {
            ...
            return ((DataPosition + 6) == (Offset + SizeVertWatch7()));
        }
        private UInt16 SizeVertWatch9() { return 28; }
        private bool ImportVertWatch9(UInt16 Offset, ref byte[] Data)
        {
            UInt16 ItemPosition = 0;
            UInt16 DataPosition = 0;
            if (Offset > 6)
            ...
            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiF37acceptCounterLimit", TaskDataType.type_uint_16, DataPosition);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiF37acceptTimeWindow", TaskDataType.type_uint_16, DataPosition);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;
            ...
            return ((DataPosition + 6) == (Offset + SizeVertWatch9()));
        }
	}
}
