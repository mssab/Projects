/*
 * Object: HJS.ECU.Parameter.TaskConfiguration.Can2Com
 * Description: task configuration for Can2Com
 * 
 * $LastChangedDate: 2013-12-02 10:31:16 +0100 (Mo, 02 Dez 2013) $
 * $LastChangedRevision: 26 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/HJS.ECU/Parameter/TaskConfiguration.CAN2Com.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
namespace HJS.ECU.Parameter
{
    ...
    {
        private UInt16 SizeCan2Com9() { return 10; }
        private bool ImportCan2Com9(UInt16 Offset, ref byte[] Data)
        {
            ...
            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiErrorTimeLimit", TaskDataType.type_uint_16, DataPosition);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            return ((DataPosition + 6) == (Offset + SizeCan2Com9()));
        }
	}
}
