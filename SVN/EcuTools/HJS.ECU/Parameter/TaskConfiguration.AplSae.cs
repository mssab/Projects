/*
 * Object: HJS.ECU.Parameter.TaskConfiguration.AplSae
 * Description: task configuration for sae application
 * 
 * $LastChangedDate: 2013-12-02 10:31:16 +0100 (Mo, 02 Dez 2013) $
 * $LastChangedRevision: 26 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/HJS.ECU/Parameter/TaskConfiguration.AplSae.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
namespace HJS.ECU.Parameter
{
    ...
    {
        private UInt16 SizeAplSae7() { return 8; }
        private bool ImportAplSae7(UInt16 Offset, ref byte[] Data)
        {
            ...
            return ((DataPosition + 6) == (Offset + SizeAplSae7()));
        }
        private UInt16 SizeAplSae9() { return 28; }
        private bool ImportAplSae9(UInt16 Offset, ref byte[] Data)
        {
            UInt16 ItemPosition = 0;
            UInt16 DataPosition = 0;
            if (Offset > 6)
            ...
            return ((DataPosition + 6) == (Offset + SizeAplSae9()));
        }
	}
}
