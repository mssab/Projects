/*
 * Object: EcuDiagnose.Controller
 * Description: Application controller object
 * 
 * $LastChangedDate: 2014-08-13 08:18:17 +0200 (Mi, 13 Aug 2014) $
 * $LastChangedRevision: 67 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/EcuDiagnose/Controller.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
namespace EcuDiagnose
{
    ...
    {
        private Forms.FrameForm mFrameForm;
        ...
        public byte CompatibilityNumber
        {
            ...
            {
                if (mEcuFunc == null) return 0;
                else return mEcuFunc.CompatibilityNumber;
            }
        }

        /// <summary>Constructor</summary>
        /// <param name="frameForm">Main for object</param>
        public Controller(Forms.FrameForm frameForm)
		{
        ...
        {
            mEcuFunc.SaveReadDataFile(Filename);
        }
        ...
        {
            return mEcuFunc.ReadUpdatables();
        }
        ...
        {
            return mEcuFunc.GetUpdatable(Position);
        }
        ...
        {
            return mEcuFunc.SetUpdatable(Position, Data);
        }

        /// <summary>Read list of available languages</summary>
        /// <returns>List of languages as strings</returns>
        public System.Collections.Generic.List<string> ReadAvailableLanguages()
        {
            return mEcuFunc.ReadAvailableLanguages();
        }

        /// <summary>Read list of active tasks</summary>
        /// <returns>List of active tasks as strings</returns>
        public System.Collections.Generic.List<string> ReadActiveTaskList()
        {
            return mEcuFunc.ReadActiveTaskList();
        }
        ...
        {
            return mEcuFunc.GetSerialNumber();
        }
        ...
        {
            return mEcuFunc.GetEcuTemperatureOffset();
        }
        ...
        {
            return mEcuFunc.ReadSbcRegister();
        }
    }
}
