...
namespace KonfigEditor.Forms
{
    ...
    public partial class KonfigEditorMainForm : Form
    {
        ...
        private void anyDragEnter(object sender, DragEventArgs e)
        {
        ...
        private void paramShowList_TaskSequence()
        {
            ...
            listViewParam.Columns.Add("ID", 35);
        ...
        private void listViewParam_DoubleClick(object sender, EventArgs e)
        {
            ...
            else MessageBox.Show("Keine Auswahl");
        }

        private void paramEditListItem_Init(int ItemNo, string ItemName)
        {
        ...
        private void paramEditListItem_Task(int TaskNo, int ItemNo, string ItemName)
        {
