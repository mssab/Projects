 ...
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/tags/Version_1_3_1/lib_cs_win32_hjsecu/BlockFile.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
{
    /// <summary>
    /// Block file object class
    /// </summary>
    public class BlockFile
    {
        /// <summary>
        /// Enumeration for identifiers different block file types
        /// (file extension)
        /// </summary>
        public enum FileIdentifier : byte
        {
            ...
            ParameterSet = 75,
            /// <summary>
            /// Draft of parameter set (V)
            /// </summary>
            Draft = 86,
            /// <summary>
            /// Data read from System (D)
            /// </summary>
            ReadData = 44
        }
        ...
        /// Exisiting files will be truncated
        /// </summary>
        ...
        /// This function can not replace existing blocks!
        /// </summary>
        ...
        /// <summary>
        ///  Block file format version number
        /// </summary>
	    private const UInt16 VERSION_OF_BLOCK_FILE = 1;

        /// <summary>
        /// constant for second identifier byte : B
        /// </summary>
        private const byte FILE_ID_2 = 66;

        /// <summary>
        /// constant for third identifier byte : F
        /// </summary>
        private const byte FILE_ID_3 = 70;

        /// <summary>
        /// Number of containing blocks
        /// </summary>
