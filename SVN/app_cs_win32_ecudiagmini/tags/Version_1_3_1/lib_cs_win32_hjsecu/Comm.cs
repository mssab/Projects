 ...
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/tags/Version_1_3_1/lib_cs_win32_hjsecu/Comm.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
{
    /// <summary>
    /// Interface to port object
    /// </summary>
    public abstract class Comm
    {
        /// <summary>
        /// Enumeration for protocol status byte contents
        /// </summary>
        public enum StatusByte : byte
        {
            ...
            NoError = 0,
            /// <summary>
            /// Status No 2nd Flash device 0x78
            /// </summary>
            NoDecive = 120,
            /// <summary>
            /// Status ECU mode does not match STB 0x79
            /// </summary>
            ModeFailed = 121,
            /// <summary>
            /// Status CRC16 error 0x7A
            /// </summary>
            ChecksumError = 122,
            /// <summary>
            /// Status Could not execute STB 0x7B
            /// </summary>
            OrderFailed = 123,
            /// <summary>
            /// Status Password error 0x7C
            /// </summary>
            PasswordError = 124,
            /// <summary>
            /// Status RS232 Protocol error 0x7D
            /// </summary>
            VersionError = 125,
            /// <summary>
            /// Status Unknown STB 0x7E
            /// </summary>
            UnknownOrder = 126,
            /// <summary>
            /// Status Un synchronous (1. 10Byte wrong) 0x7F
            /// </summary>
            SyncError = 127
        }

        /// <summary>
        /// Enumeration for orders (formally known as STB)
        /// </summary>
        public enum OrderByte : byte
        {
            /// <summary>
            /// Null enumeration, invalid command
            /// </summary>
            Invalid = 0,
            /// <summary>
            ...
            /// <summary>
            /// Read values (measurement and calculated)
            /// </summary>
            ReadActualValues = 23,
            /// <summary>
            /// Check communication
            ...
            ReadErrorRing = 25,
            /// <summary>
            /// Read error ring sector
            /// </summary>
            ReadErrorRingSector = 26,
            /// <summary>
            /// Write configuration and datamap
            /// </summary>
            WriteCfgKf = 27,
            /// <summary>
            /// Read acquisition sector from device 1
            /// </summary>
            ReadAcquiDev1Sector = 28,
            /// <summary>
            /// Read acquisition sector from device 2
            /// </summary>
            ...
            WriteDataMap = 38,
            /// <summary>
            /// Read digital information block
            /// </summary>
            ReadInfoBlock = 39,
            /// <summary>
            ...
            WriteLanguageEn = 41,
            /// <summary>
            /// Write french Language
            /// </summary>
            WriteLanguageFr = 42,
            /// <summary>
            /// Write italian language
            /// </summary>
            WriteLanguageIt = 43,
            /// <summary>
            /// Delete error ring data
            /// </summary>
            ResetErrorRing = 44,
            /// <summary>
            ...
            /// <summary>
            /// Read acquisition and error ring definitions and info
            /// </summary>
            ReadRingInfo = 63,
            /// <summary>
            /// Set additive refilled
            /// </summary>
            ...
            SetEGRToggle = 72,
            /// <summary>
            /// Start pressure averaging
            /// </summary>
            StartPressureMeasurement = 73,
            /// <summary>
            /// Set warning level pressure
            /// </summary>
            SetWarningPressure = 74,
            /// <summary>
            /// Set alarm level pressure
            /// </summary>
            SetAlarmPressure = 75,
            /// <summary>
            /// Set alarm level time
            /// </summary>
            SetAlarmTimeDelay = 76,
            /// <summary>
            /// Calibrate fuel sensor gain
            /// </summary>
            ...
            /// <summary>
            /// Delete drive pattern
            /// </summary>
            ResetDrivePatternDetection = 87,
            /// <summary>
            /// Write drive pattern 1
            /// </summary>
            WriteDrivePatternDetection1 = 88,
            /// <summary>
            /// Write drive pattern 2
            /// </summary>
            WriteDrivePatternDetection2 = 89,
            /// <summary>
            /// Write empirical values 1
            /// </summary>
            WriteValue1 = 90,
            /// <summary>
            /// write empirical values 2
            /// </summary>
            WriteValue2 = 91,
            /// <summary>
            /// Write behave ring 1
            ...
            /// <summary>
            /// Calibrate ambient pressure sensor
            /// </summary>
            StartAmbientPressureSensorCalibration = 115,
            /// <summary>
            /// Read Mask with availabe Languages
            /// </summary>
            ReadLanguageMask = 116,
            /// <summary>
            /// Calibrate Venturi pressure sensor
            /// </summary>
            StartVenturiSensorCalibration = 117,
            /// <summary>
            /// Set wanring level time
            /// </summary>
            ...
            TesterOutputs = 135,
            /// <summary>
            /// Tester enable flashing
            /// </summary>
            TesterFlash = 137,
            /// <summary>
            /// Tester disable flashing
            /// </summary>
            TesterNoFlash = 138
        }

        /// <summary>
        /// Enumeration for type of port
        /// </summary>
        public enum PortType
        {
            /// <summary>
            /// Direct communication with RS232
            /// </summary>
            Direct = 0,
            /// <summary>
            /// Indirect communication with modem
            /// </summary>
            Modem
        }
        ...
        /// <summary>
        /// Accessors for current protocol version
        /// Get from header to PC or set to header to ECU
        /// </summary>
        ...
        /// <summary>
        /// Accessors for string of current port name
        /// </summary>
        ...
        /// <summary>
        /// Accessors for server identification (100 = d, or 112 = p)
        /// </summary>
        ...
        /// <summary>
        /// Send an order with an 16-bit-value to ECU
        /// </summary>
        /// <param name="STB">Communication order identifier</param>
        /// <param name="Value">Special value to be send in Size parameter</param>
        /// <returns>0 on success, else error (see ReturnValue)</returns>
        ...
        /// <summary>
        /// Send an order to ECU with an 16-bit-value and wait for ECU to execute command
        /// </summary>
        /// <param name="STB">Communication order identifier</param>
        /// <param name="Value">Special value to be send in Size parameter</param>
