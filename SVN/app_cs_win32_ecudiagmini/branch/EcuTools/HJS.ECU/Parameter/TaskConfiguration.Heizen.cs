/*
 * Object: HJS.ECU.Parameter.TaskConfiguration.Heizen
 * Description: task configuration for Heizen
 * 
 * $LastChangedDate: 2014-11-03 16:18:26 +0100 (Mo, 03 Nov 2014) $
 * $LastChangedRevision: 74 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/HJS.ECU/Parameter/TaskConfiguration.Heizen.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
namespace HJS.ECU.Parameter
{
    ...
    {
        private UInt16 SizeHeizen7() { return 22; }
        private bool ImportHeizen7(UInt16 Offset, ref byte[] Data)
        {
            ...
            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiHeizLeistung", TaskDataType.type_uint_16, DataPosition);
            mItem[ItemPosition].SetPlausibilityMin(550);
            mItem[ItemPosition].SetPlausibilityMax(1050);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiWiderstand", TaskDataType.type_uint_16, DataPosition);
            mItem[ItemPosition].SetPlausibilityMin(34);
            mItem[ItemPosition].SetPlausibilityMax(47);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiMinStromEin", TaskDataType.type_uint_16, DataPosition);
            mItem[ItemPosition].SetPlausibilityMin(2700);
            mItem[ItemPosition].SetPlausibilityMax(3200);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiMaxStromEin", TaskDataType.type_uint_16, DataPosition);
            mItem[ItemPosition].SetPlausibilityMin(5400);
            mItem[ItemPosition].SetPlausibilityMax(6000);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiPpgFrequenz", TaskDataType.type_uint_16, DataPosition);
            mItem[ItemPosition].SetPlausibilityMin(20833);
            mItem[ItemPosition].SetPlausibilityMax(20833);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("ucRkreis", TaskDataType.type_uint_8, DataPosition);
            mItem[ItemPosition].SetPlausibilityMin(1);
            DataPosition = (UInt16)(DataPosition + 1); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("ucModus", TaskDataType.type_uint_8, DataPosition);
            mItem[ItemPosition].SetPlausibilityMax(3);
            DataPosition = (UInt16)(DataPosition + 1); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiLowVolt", TaskDataType.type_uint_16, DataPosition);
            mItem[ItemPosition].SetPlausibilityMin(11100);
            mItem[ItemPosition].SetPlausibilityMax(22000);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            return ((DataPosition + 6) == (Offset + SizeHeizen7()));
        }
        private UInt16 SizeHeizen9() { return 42; }
        private bool ImportHeizen9(UInt16 Offset, ref byte[] Data)
        {
            UInt16 ItemPosition = 0;
            UInt16 DataPosition = 0;
            if (Offset > 6)
            ...
            return ((DataPosition + 6) == (Offset + SizeHeizen9()));
        }
	}
}
