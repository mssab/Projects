/*
 * Object: HJS.ECU.Parameter.TaskConfiguration.TurnSpeed
 * Description: task configuration for TurnSpeed
 * 
 * $LastChangedDate: 2014-05-20 10:02:31 +0200 (Di, 20 Mai 2014) $
 * $LastChangedRevision: 53 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/HJS.ECU/Parameter/TaskConfiguration.Turnspeed.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
namespace HJS.ECU.Parameter
{
    ...
    {
        private UInt16 SizeTurnspeed7() { return 14; }
        private bool ImportTurnSpeed7(UInt16 Offset, ref byte[] Data)
        {
            ...
            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("fFaktorSpeed", TaskDataType.type_float_32, DataPosition);
            DataPosition = (UInt16)(DataPosition + 4); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("uiTakteProHundertMeter", TaskDataType.type_uint_16, DataPosition);
            DataPosition = (UInt16)(DataPosition + 2); ItemPosition++;

            return ((DataPosition + 6) == (Offset + SizeTurnspeed7()));
        }
        private UInt16 SizeTurnspeed9() { return 36; }
        private bool ImportTurnSpeed9(UInt16 Offset, ref byte[] Data)
        {
            UInt16 ItemPosition = 0;
            UInt16 DataPosition = 0;
            if (Offset > 6)
            ...
            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("ucUseAirMass", TaskDataType.type_int_8, DataPosition);
            DataPosition = (UInt16)(DataPosition + 1); ItemPosition++;

            Array.Resize(ref mItem, ItemPosition + 1);
            mItem[ItemPosition] = new TaskConfigurationItem("eMrwAirMassSource", TaskDataType.type_enum_mrw_8, DataPosition);
            DataPosition = (UInt16)(DataPosition + 1); ItemPosition++;
            ...
            return ((DataPosition + 6) == (Offset + SizeTurnspeed9()));
        }
	}
}
