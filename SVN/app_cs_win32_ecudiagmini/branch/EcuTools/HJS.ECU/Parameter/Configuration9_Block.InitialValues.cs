 ...
 * Description: Configuration parameter block compatibility 9 initial values
 * 
 * $LastChangedDate: 2014-11-26 13:48:11 +0100 (Mi, 26 Nov 2014) $
 * $LastChangedRevision: 76 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/HJS.ECU/Parameter/Configuration9_Block.InitialValues.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
...
{
    public partial class Configuration9_Block
    {
        ...
        public override string CheckInitValueItems()
        {
            ...
            if (InitValueItem != null)
            {
                ...
                {
                    ret = InitValueItem[position].CheckValue(ref mBlockData, 9);
        ...
        public override void InitValueImport()
        {
            ...
            Array.Resize(ref InitValueItem, 59);
