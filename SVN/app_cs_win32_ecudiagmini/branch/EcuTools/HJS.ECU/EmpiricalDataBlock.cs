 ...
 * 
 * $LastChangedDate: 2015-03-03 14:40:31 +0100 (Di, 03 Mrz 2015) $
 * $LastChangedRevision: 98 $
 * $LastChangedBy: ksi $
 * $HeadURL: http://menden22/svn/devel/electronic/app_cs_win32_ecudiagmini/branch/EcuTools/HJS.ECU/EmpiricalDataBlock.cs $
 * 
 * LastReviewDate: 
 * LastReviewRevision: 
 * LastReviewBy: 
        ...
        public string GetEmpiricalValue(GroupName Group, UInt16 Position)
        {
            ...
            switch (Group)
            {
                case GroupName.Regenerieren:
                    switch (Position)
                    {
                        ...
                        case 5:
                            ...
                            if (ui32 != 0xFFFFFFFF)
                            {
                                ret = String.Format("sReg.ulLastSelfRegDetect = {0}", ui32);
                            }
                            else
                            {
                                ret = "sReg.ulLastSelfRegDetect = -1";
                            }
                            break;
                        default:
                            ret = "N/A";
                ...
                case GroupName.Heizen:
                    ...
                    switch (Position)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            ui32 = (UInt32)(mBlockData[offset + 18] * 256);
                            ui32 += mBlockData[offset + 17];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 16];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 15];
                ...
                case GroupName.BeladungCRT:
                    ...
                    switch (Position)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            ui32 = (UInt32)(mBlockData[offset + 26] * 256);
                            ui32 += mBlockData[offset + 25];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 24];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 23];
                        ...
                        case 19:
                            ...
                            break;
                        case 20:
                            ui32 = (UInt32)(mBlockData[offset + 64] * 256);
                            ui32 += mBlockData[offset + 63];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 62];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 61];
                            ret = String.Format("sBeladCRT.ulTempKoeffSummeCRT = {0}", ui32);
                            break;
                        case 21:
                            ui16 = (UInt16)(mBlockData[offset + 66] * 256);
                            ui16 += mBlockData[offset + 65];
                            ret = String.Format("sBeladCRT.uiTempKoeffCRT = {0}", ui16);
                            break;
                        case 22:
                            ui16 = (UInt16)(mBlockData[offset + 68] * 256);
                            ui16 += mBlockData[offset + 67];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCounter = {0}", ui16);
                            break;
                        case 23:
                            ui16 = (UInt16)(mBlockData[offset + 70] * 256);
                            ui16 += mBlockData[offset + 69];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[0] = {0}", ui16);
                            break;
                        case 24:
                            ui16 = (UInt16)(mBlockData[offset + 72] * 256);
                            ui16 += mBlockData[offset + 71];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[1] = {0}", ui16);
                            break;
                        case 25:
                            ui16 = (UInt16)(mBlockData[offset + 74] * 256);
                            ui16 += mBlockData[offset + 73];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[2] = {0}", ui16);
                            break;
                        case 26:
                            ui16 = (UInt16)(mBlockData[offset + 76] * 256);
                            ui16 += mBlockData[offset + 75];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[3] = {0}", ui16);
                            break;
                        case 27:
                            ui16 = (UInt16)(mBlockData[offset + 78] * 256);
                            ui16 += mBlockData[offset + 77];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[4] = {0}", ui16);
                            break;
                        case 28:
                            ui16 = (UInt16)(mBlockData[offset + 80] * 256);
                            ui16 += mBlockData[offset + 79];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[5] = {0}", ui16);
                            break;
                        case 29:
                            ui16 = (UInt16)(mBlockData[offset + 82] * 256);
                            ui16 += mBlockData[offset + 81];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[6] = {0}", ui16);
                            break;
                        case 30:
                            ui16 = (UInt16)(mBlockData[offset + 84] * 256);
                            ui16 += mBlockData[offset + 83];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[7] = {0}", ui16);
                            break;
                        case 31:
                            ui16 = (UInt16)(mBlockData[offset + 86] * 256);
                            ui16 += mBlockData[offset + 85];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[8] = {0}", ui16);
                            break;
                        case 32:
                            ui16 = (UInt16)(mBlockData[offset + 88] * 256);
                            ui16 += mBlockData[offset + 87];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[9] = {0}", ui16);
                            break;
                        case 33:
                            ui16 = (UInt16)(mBlockData[offset + 90] * 256);
                            ui16 += mBlockData[offset + 89];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[10] = {0}", ui16);
                            break;
                        case 34:
                            ui16 = (UInt16)(mBlockData[offset + 92] * 256);
                            ui16 += mBlockData[offset + 91];
                            ret = String.Format("sBeladCRT.uiTempKoeffFeldCRT[11] = {0}", ui16);
                            break;
                        case 35:
                            ui16 = (UInt16)(mBlockData[offset + 94] * 256);
                            ui16 += mBlockData[offset + 93];
                            ret = String.Format("sBeladCRT.uiTempMessungCounter = {0}", ui16);
                            break;
                        case 36:
                            ui16 = (UInt16)(mBlockData[offset + 96] * 256);
                            ui16 += mBlockData[offset + 95];
                            ret = String.Format("sBeladCRT.uiTempTimeCounter = {0}", ui16);
                            break;
                        case 37:
                            ui16 = (UInt16)(mBlockData[offset + 98] * 256);
                            ui16 += mBlockData[offset + 97];
                            ret = String.Format("sBeladCRT.uiFilterbeladung = {0}", ui16);
                            break;
                        case 38:
                            ui16 = (UInt16)(mBlockData[offset + 100] * 256);
                            ui16 += mBlockData[offset + 99];
                ...
                case GroupName.Flash:
                    ...
                    {
                        case 0:
                            ui16 = (UInt16)(mBlockData[offset + 102] * 256);
                            ui16 += mBlockData[offset + 101];
                            ret = String.Format("sFlash.uiPsocFlashCounter = {0}", ui16);
                            break;
                        case 1:
                            ui16 = (UInt16)(mBlockData[offset + 104] * 256);
                            ui16 += mBlockData[offset + 103];
                            ret = String.Format("sFlash.uiSaveValueCt = {0}", ui16);
                            break;
                        case 2:
                            ui16 = (UInt16)(mBlockData[offset + 106] * 256);
                            ui16 += mBlockData[offset + 105];
                            ret = String.Format("sFlash.uiRingError = {0}", ui16);
                            break;
                        case 3:
                            ui16 = (UInt16)(mBlockData[offset + 108] * 256);
                            ui16 += mBlockData[offset + 107];
                            ret = String.Format("sFlash.uiAcquiError = {0}", ui16);
                            break;
                        case 4:
                            ui16 = (UInt16)(mBlockData[offset + 110] * 256);
                            ui16 += mBlockData[offset + 109];
                            ret = String.Format("sFlash.uiMasterreset = {0}", ui16);
                            break;
                        case 5:
                            ui16 = (UInt16)(mBlockData[offset + 112] * 256);
                            ui16 += mBlockData[offset + 111];
                            ret = String.Format("sFlash.uiMasterresetFailCount = {0}", ui16);
                            break;
                        case 6:
                            ui16 = (UInt16)(mBlockData[offset + 114] * 256);
                            ui16 += mBlockData[offset + 113];
                            ret = String.Format("sFlash.uiValueSafeError = {0}", ui16);
                            break;
                        case 7:
                            ui32 = (UInt32)(mBlockData[offset + 118] * 256);
                            ui32 += mBlockData[offset + 117];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 116];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 115];
                ...
                case GroupName.Additivieren:
                    ...
                    switch (Position)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            ui32 = (UInt32)(mBlockData[offset + 123] * 256);
                            ui32 += mBlockData[offset + 122];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 121];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 120];
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            ui32 = (UInt32)(mBlockData[offset + 128] * 256);
                            ui32 += mBlockData[offset + 127];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 126];
                            ui32 = (UInt32)(ui32 * 256);
                            ui32 += mBlockData[offset + 125];
                ...
                case GroupName.IKD:
                    ...
                    {
                        case 0:
                            ret = String.Format("sICD.ucRingPointer = {0}", mBlockData[offset + 129]);
                            break;
                        case 1:
                            ui16 = (UInt16)(mBlockData[offset + 131] * 256);
                            ui16 += mBlockData[offset + 130];
                            ret = String.Format("sICD.uiaRingValue[0] = {0}", ui16);
                            break;
                        case 2:
                            ui16 = (UInt16)(mBlockData[offset + 133] * 256);
                            ui16 += mBlockData[offset + 132];
                            ret = String.Format("sICD.uiaRingValue[1] = {0}", ui16);
                            break;
                        case 3:
                            ui16 = (UInt16)(mBlockData[offset + 135] * 256);
                            ui16 += mBlockData[offset + 134];
                            ret = String.Format("sICD.uiaRingValue[2] = {0}", ui16);
                            break;
                        case 4:
                            ui16 = (UInt16)(mBlockData[offset + 137] * 256);
                            ui16 += mBlockData[offset + 136];
                            ret = String.Format("sICD.uiaRingValue[3] = {0}", ui16);
                            break;
                        case 5:
                            ui16 = (UInt16)(mBlockData[offset + 139] * 256);
                            ui16 += mBlockData[offset + 138];
                            ret = String.Format("sICD.uiaRingValue[4] = {0}", ui16);
                            break;
                        case 6:
                            ui16 = (UInt16)(mBlockData[offset + 141] * 256);
                            ui16 += mBlockData[offset + 140];
                            ret = String.Format("sICD.uiaRingValue[5] = {0}", ui16);
                            break;
                        case 7:
                            ui16 = (UInt16)(mBlockData[offset + 143] * 256);
                            ui16 += mBlockData[offset + 142];
                            ret = String.Format("sICD.uiaRingValue[6] = {0}", ui16);
                            break;
                        case 8:
                            ui16 = (UInt16)(mBlockData[offset + 145] * 256);
                            ui16 += mBlockData[offset + 144];
                            ret = String.Format("sICD.uiaRingValue[7] = {0}", ui16);
                            break;
                        case 9:
                            ui16 = (UInt16)(mBlockData[offset + 147] * 256);
                            ui16 += mBlockData[offset + 146];
                            ret = String.Format("sICD.uiaRingValue[8] = {0}", ui16);
                            break;
                        case 10:
                            ui16 = (UInt16)(mBlockData[offset + 149] * 256);
                            ui16 += mBlockData[offset + 148];
                            ret = String.Format("sICD.uiaRingValue[9] = {0}", ui16);
                            break;
                        case 11:
                            ui16 = (UInt16)(mBlockData[offset + 151] * 256);
                            ui16 += mBlockData[offset + 150];
                            ret = String.Format("sICD.uiaRingValue[10] = {0}", ui16);
                            break;
                        case 12:
                            ui16 = (UInt16)(mBlockData[offset + 153] * 256);
                            ui16 += mBlockData[offset + 152];
                            ret = String.Format("sICD.uiaRingValue[11] = {0}", ui16);
                            break;
                        case 13:
                            ui16 = (UInt16)(mBlockData[offset + 155] * 256);
                            ui16 += mBlockData[offset + 154];
                            ret = String.Format("sICD.uiaRingValue[12] = {0}", ui16);
                            break;
                        case 14:
                            ret = String.Format("sICD.ucaRingReg[0] = {0}", mBlockData[offset + 155]);
                            break;
                        case 15:
                            ret = String.Format("sICD.ucaRingReg[1] = {0}", mBlockData[offset + 156]);
                            break;
                        case 16:
                            ret = String.Format("sICD.ucaRingReg[2] = {0}", mBlockData[offset + 157]);
                            break;
                        case 17:
                            ret = String.Format("sICD.ucaRingReg[3] = {0}", mBlockData[offset + 158]);
                            break;
                        case 18:
                            ret = String.Format("sICD.ucaRingReg[4] = {0}", mBlockData[offset + 159]);
                            break;
                        case 19:
                            ret = String.Format("sICD.ucaRingReg[5] = {0}", mBlockData[offset + 160]);
                            break;
                        case 20:
                            ret = String.Format("sICD.ucaRingReg[6] = {0}", mBlockData[offset + 161]);
                            break;
                        case 21:
                            ret = String.Format("sICD.ucaRingReg[7] = {0}", mBlockData[offset + 162]);
                            break;
                        case 22:
                            ret = String.Format("sICD.ucaRingReg[8] = {0}", mBlockData[offset + 163]);
                            break;
                        case 23:
                            ret = String.Format("sICD.ucaRingReg[9] = {0}", mBlockData[offset + 164]);
                            break;
                        case 24:
                            ret = String.Format("sICD.ucaRingReg[10] = {0}", mBlockData[offset + 165]);
                            break;
                        case 25:
                            ret = String.Format("sICD.ucaRingReg[11] = {0}", mBlockData[offset + 166]);
                            break;
                        case 26:
                            ret = String.Format("sICD.ucaRingReg[13] = {0}", mBlockData[offset + 167]);
                            break;
                        case 27:
                            ret = String.Format("sICD.ucaRingReg[12] = {0}", mBlockData[offset + 168]);
                            break;
                        case 28:
                            ui16 = (UInt16)(mBlockData[offset + 170] * 256);
                            ui16 += mBlockData[offset + 169];
                            ret = String.Format("sICD.uiAvgFilterLoad = {0}", ui16);
                            break;
                        case 29:
                            ui16 = (UInt16)(mBlockData[offset + 172] * 256);
                            ui16 += mBlockData[offset + 171];
                    ...
                    {   // ab v 8
                        switch (Position)
                        {
                            ...
                            case 7:
                                ...
                                break;
                            case 8:
                                ui16 = (UInt16)(mBlockData[offset + 16] * 256);
                                ui16 += mBlockData[offset + 15];
                                ret = String.Format("sVert.uiTvorAlarmTime = {0}", ui16);
                                break;
                            case 9:
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (Version < 9)
                                {
                                    offset = 173 + 2 + 50 + 57; //173 + 6 + 50 + 61;
                                }
                                else
                                {
                                    offset = 4 + 173 + 2 + 50 + 57; //173 + 6 + 50 + 61;
                                }
                            }
                        }
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (Version < 9)
                                {
                                    offset = 173 + 6 + 50 + 57; //offset = 173 + 10 + 50 + 61;
                                }
                                else
                                {
                                    offset = 4 + 173 + 6 + 50 + 57; //offset = 173 + 10 + 50 + 61;
                                }
                            }
                        }
                    }
                ...
                case GroupName.DPD:
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (Version < 9)
                                {
                                    offset = 173 + 10 + 50 + 57; //offset = 173 + 14 + 50 + 61;
                                }
                                else
                                {
                                    offset = 4 + 173 + 10 + 50 + 57; //offset = 173 + 14 + 50 + 61;
                                }
                            }
                        }
                    }
                    ...
                    {
                        ret = String.Format("sDPD.asJNRestlaufzeit[{0}].Nibble N={1} J={2}", Position, mBlockData[offset + Position] & 0x0F, (mBlockData[offset + Position] & 0xF0) >> 4);
                    }
                    break;
                case GroupName.Tankgeber:
                    if (Version <= 4)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (Version < 9)
                                {
                                    offset = 173 + 46 + 15 + 10 + 50 + 57; //offset = 173 + 46 + 15 + 14 + 50 + 61;
                                }
                                else
                                {
                                    offset = 4 + 173 + 46 + 15 + 10 + 50 + 57; //offset = 173 + 46 + 15 + 14 + 50 + 61;
                                }
                            }
                        }
                    }
                ...
                case GroupName.Updateables:
                    ...
                    if (Version < 9)
                    {
                        offset = 359; //173 + 46 + 15 + 10 + 50 + 57 + 8;
                    }
                    else
                    {
                        offset = 363; //4 + 173 + 46 + 15 + 10 + 50 + 57 + 8;
                    }
                    switch (Position)
                    {
                        case 0:
                            ui16 = (UInt16)(mBlockData[offset + 1] * 256);
                            ui16 += mBlockData[offset + 0];
                            ret = String.Format("sUpdateable.Vert_uiPalarm = {0}", ui16);
                            break;
                        case 1:
                            ui16 = (UInt16)(mBlockData[offset + 3] * 256);
                            ui16 += mBlockData[offset + 2];
                            ret = String.Format("sUpdateable.Vert_uiTalarm = {0}", ui16);
                            break;
                        case 2:
                            ui16 = (UInt16)(mBlockData[offset + 5] * 256);
                            ui16 += mBlockData[offset + 4];
                            ret = String.Format("sUpdateable.Vert_uiPwarn = {0}", ui16);
                            break;
                        case 3:
                            ui16 = (UInt16)(mBlockData[offset + 7] * 256);
                            ui16 += mBlockData[offset + 6];
                            ret = String.Format("sUpdateable.Vert_uiTwarn = {0}", ui16);
                            break;
                        case 4:
                            ui16 = (UInt16)(mBlockData[offset + 9] * 256);
                            ui16 += mBlockData[offset + 8];
                            ret = String.Format("sUpdateable.(IC)Dosing_uiKraftstoffverbrauch = {0}", ui16);
                            break;
                        case 5:
                            f32 = BitConverter.ToSingle(mBlockData, offset + 10);
                            ret = String.Format("sUpdateable.Staudruck_fAirMassKFactor = {0}", f32);
                            break;
                        case 6:
                            f32 = BitConverter.ToSingle(mBlockData, offset + 14);
                            ret = String.Format("sUpdateable.Turnspeed_fFaktorTurns = {0}", f32);
                            break;
                        case 7:
                            ui32 = BitConverter.ToUInt32(mBlockData, offset + 18);
                            ret = String.Format("sUpdateable.Dosieren_ulTankinhalt = {0}", ui32);
                            break;
                        case 8:
                            ui32 = BitConverter.ToUInt32(mBlockData, offset + 22);
                            ret = String.Format("sUpdateable.Additivierung_ulAddStandard = {0}", ui32);
                            break;
                        case 9:
                            f32 = BitConverter.ToSingle(mBlockData, offset + 26);
                            ret = String.Format("sUpdateable.Maf_fDisplacedVolume = {0}", f32);
                            break;
                        default:
                            ret = "N/A";
                            break;
